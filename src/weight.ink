...
Two researchers (a physicist and a software engineer) at a prominent national laboratory are discussing the limitations of current physics and lamenting that we've not really been able to harness nuclear reactions as effectively as we have electromagnetic and, to a lesser extent, quantum effects.  We all have quantum encrypted cell phones broadcasting through satellites, but almost no one uses nukes outside of mass power generation or mutually assured destruction scenarios. They discuss the lack of usable equations for gravity at a distance, particularly in the context of electromagnetic interactions.  
